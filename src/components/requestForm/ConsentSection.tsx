      ...
      <CardContent className="p-0 space-y-6">
        ...
        <div className="border rounded-md p-4 bg-muted/20">
          ...
          <div className="text-sm text-muted-foreground max-h-56 overflow-y-auto p-2 border rounded-md bg-background">
            ...
            <p className="mb-2 text-body">
              Usted autoriza a Crédito Productivo y sus socios comerciales a verificar toda la información proporcionada, incluyendo pero no limitado a: historial crediticio, historial laboral, referencias personales y cualquier otra información relevante para el proceso de evaluación crediticia.
            </p>
            <p className="mb-2 text-body">
