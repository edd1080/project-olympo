...
const DocumentCapture: React.FC<DocumentCaptureProps> = ({
  ...
  if (previewImage) {
    return (
      <div className="w-full max-w-md mx-auto space-y-4">
        ...
        <div className="mb-4">
          <div className="relative w-full max-w-sm mx-auto aspect-[3/2] bg-muted rounded-lg overflow-hidden border-2 border-dashed border-muted-foreground/30">
            <img 
              src={previewImage} 
              alt="Vista previa" 
  ...
  return (
    <div className="w-full max-w-md mx-auto space-y-4">
      ...
      <div className="mb-4">
        <div 
          className="relative w-full max-w-sm mx-auto aspect-[3/2] bg-muted rounded-lg border-2 border-dashed border-primary/30 overflow-hidden cursor-pointer hover:border-primary/50 transition-colors"
