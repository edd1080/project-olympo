  ...
  return (
    <Card className="border-0 shadow-none">
      <CardContent className="p-0 space-y-6">
        <h3 className="font-semibold text-lg">Consentimiento</h3>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start space-x-3">
            ...
            />
            <div className="grid gap-1.5 leading-none">
              <Label htmlFor="dataProcessing" className="text-sm font-normal">
          ...
          <div className="flex items-start space-x-3">
            ...
            />
            <div className="grid gap-1.5 leading-none">
              <Label htmlFor="creditCheck" className="text-sm font-normal">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="grid gap-1.5 leading-none">
              <Label htmlFor="marketing" className="text-sm font-normal">
                Deseo recibir información sobre ofertas y productos relacionados (opcional).
              </Label>
            </div>
          </div>
